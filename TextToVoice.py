...
# 正常天气
text_normal = 'xxx早上好呀！现在外面' + now_temp + '度，' + '今天最低温度为：' + tempMin + '度，' + '最高温度为：' + tempMax + '度，' \
              + '看好温度穿衣哦！' + '再提醒一下，今天的日落时间是，' + sunsetTime + '，祝您傍晚能看到美丽的日落！拜拜～'
# 最高温度小于14度时
text_lowtemp = 'xxxx早上好呀！现在外面' + now_temp + '度，' + '今天最低温度为：' + tempMin + '度！' + '最高温度也才：' + tempMax + '度，' \
               + '，也是好冷的呢！要多穿衣服哦！' + '再提醒一下，今天的日落时间是，' + sunsetTime + '祝xxxx傍晚能看到美丽的日落！拜拜～'
# 下雨
text_rain = 'xxxx早上好呀！现在外面' + now_temp + '度，' + '外边正在下雨呢，记得带伞～' + '今天最低温度为：' + tempMin + '度，' + '最高温度为：' + tempMax + '度，' \
            + '看好温度穿衣哦！' + '再提醒一下，今天的日落时间是，' + sunsetTime + '祝xxxx傍晚能看到美丽的日落！拜拜～' + '对了，记得带伞哦！再见'
